...
/*Pre: Theuserspecifiesthenumberoftimeunitsinthesimulation,themaximal queue sizes permitted, and the expected arrival and departure rates for the airport.
...
/*Post: The specified time isprinted with a message that the runway isidle.*/ {
...
int main(int argc, const char * argv[]) {
    ...
    /*Pre: The user must supply the number of time intervalsthe simulation isto run, the expected number of planes arriving, the expected number of planes departing per time interval, and the maximum allowed size for runway
     queues.
     ...
     Uses: ClassesRunway, Plane, Random and functionsrun_idle, initialize.*/
